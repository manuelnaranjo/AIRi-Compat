...
public class ScriptService extends ForegroundService {
	...
	public void onStart(Intent intent, final int startId) {
		...
		//If you want to register any new Facade this is the time!
		//Use FacadeConfiguration.addFacade(class)
		//class needs to extend from RpcReceiver
		FacadeConfiguration.addFacade(TestFacade.class);
